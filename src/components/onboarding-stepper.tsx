...
const steps = [
  { id: 1, name: 'Business details', component: StepBusinessDetails },
  { id: 2, name: 'Business objectives', component: StepBusinessObjectives },
  { id: 3, name: 'Data collection', component: StepDataCollection },
];
...
export function OnboardingStepper({ onComplete }: OnboardingStepperProps) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 md:p-8">
       <div className="mb-8">
            <h1 className="text-3xl font-bold text-center font-headline mb-2">Welcome to Karigar!</h1>
