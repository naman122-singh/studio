...
export default function AboutPage() {
    return (
        <div className="container mx-auto px-4 py-12">
            <h1 className="text-4xl font-bold font-headline text-center mb-8 flex items-center justify-center gap-2">About <span className="font-hindi text-5xl font-normal">कला</span> Saathi</h1>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                        The idea for Kala Saathi was born from a deep appreciation for India's rich cultural tapestry and a concern for the artisans who are the custodians of these traditions. We saw that many talented craftsmen struggled to reach a wider audience, get fair prices for their work, and adapt to the digital marketplace.
                    </p>
                    <p className="text-muted-foreground">
                        We decided to create a "Saathi" - a companion - that would use the power of Artificial Intelligence to provide artisans with the tools, insights, and support they need to succeed. From generating stunning product images to suggesting sales strategies, Kala Saathi is designed to be a trusted partner in every artisan's journey.
                    </p>
                </div>
            ...
            <div className="bg-muted p-8 rounded-lg text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                    Whether you are an artisan looking to grow your business, a lover of traditional crafts, or someone who believes in the power of technology to make a positive impact, we invite you to join the Kala Saathi community.
                </p>
